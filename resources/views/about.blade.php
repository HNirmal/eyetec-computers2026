<x-guest-layout>
    <main class="min-h-screen bg-gray-100">
        ...
        <section class="relative h-72 md:h-96 flex items-center justify-center" style="background-color: #151c28;">
            ...
            <img src="{{ asset('images/products/images/banner2.webp') }}" alt="Banner" class="absolute inset-0 w-full h-full object-cover opacity-70 z-0" style="pointer-events: none;" />
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    <div class="bg-white rounded-xl shadow p-6 flex flex-col items-center">
                        <div class="bg-red-600 rounded-full flex items-center justify-center h-16 w-16 mb-5">
                            <img src="{{ asset('images/products/icons/customerr.webp') }}" alt="Customer First" class="h-8 w-8">
                        </div>
                    ...
                    <div class="bg-white rounded-xl shadow p-6 flex flex-col items-center">
                        <div class="bg-red-600 rounded-full flex items-center justify-center h-16 w-16 mb-5">
                            <img src="{{ asset('images/products/icons/tech.webp') }}" alt="Cutting-Edge Tech" class="h-8 w-8">
                        </div>
                    ...
                    <div class="bg-white rounded-xl shadow p-6 flex flex-col items-center">
                        <div class="bg-red-600 rounded-full flex items-center justify-center h-16 w-16 mb-5">
                            <img src="{{ asset('images/products/icons/dollarr.webp') }}" alt="Affordable Prices" class="h-8 w-8">
                        </div>
                    ...
                    <div class="bg-white rounded-xl shadow p-6 flex flex-col items-center">
                        <div class="bg-red-600 rounded-full flex items-center justify-center h-16 w-16 mb-5">
                            <img src="{{ asset('images/products/icons/support.webp') }}" alt="Reliable Support" class="h-8 w-8">
                        </div>
        ...
        <section class="bg-white py-12">
            <div class="container mx-auto px-4 md:px-8">
                ...
                <div class="flex flex-wrap justify-center items-center gap-8">
                    <img src="{{ asset('images/products/icons/intel.webp') }}" alt="Intel" class="h-20 w-auto">
                    <img src="{{ asset('images/products/icons/hp.webp') }}" alt="AMD" class="h-20 w-auto">
                    <img src="{{ asset('images/products/icons/nvidia.webp') }}" alt="Nvidia" class="h-20 w-auto">
                    <img src="{{ asset('images/products/icons/msi.webp') }}" alt="MSI" class="h-20 w-auto">
                    <img src="{{ asset('images/products/icons/asus.webp') }}" alt="ASUS" class="h-20 w-auto">
                    <img src="{{ asset('images/products/icons/gigabyte.png') }}" alt="Gigabyte" class="h-20 w-auto">
                    <img src="{{ asset('images/products/icons/dell.webp') }}" alt="Kingston" class="h-20 w-auto">
                    <img src="{{ asset('images/products/icons/samsung.webp') }}" alt="Samsung" class="h-20 w-auto">
                </div>
            </div>
        </section>
    </main>
