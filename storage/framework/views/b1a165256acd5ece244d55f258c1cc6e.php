...
<?php $component->withAttributes([]); ?>
    <div class="bg-gray-50 min-h-screen">
        ...
        <!-- Announcement banner -->
        <div class="w-full bg-red-600 text-white text-center text-sm font-semibold py-1">
            Latest Deals on Computers & Accessories - Shop Now!
        </div>
        ...
        <div class="max-w-7xl mx-auto px-4 py-10">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-xl shadow hover:shadow-lg transition flex flex-col">
                    ...
                    <div class="bg-white h-[220px] flex items-center justify-center relative">
                        <img
...
<?php endif; ?><?php /**PATH C:\eyetec-new\eyetec\resources\views/products.blade.php ENDPATH**/ ?>