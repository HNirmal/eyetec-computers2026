...
<div class="max-w-4xl mx-auto py-10">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($blog->image): ?>
        <div class="mt-4">
            <img src="<?php echo e(asset($blog->image)); ?>" alt="<?php echo e($blog->title); ?>" class="w-full max-h-96 object-cover rounded-lg">
        </div>
...
<?php endif; ?>
<?php /**PATH C:\eyetec-new\eyetec\resources\views/blogs/show.blade.php ENDPATH**/ ?>