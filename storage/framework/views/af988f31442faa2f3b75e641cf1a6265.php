    ...
    <div class="bg-gray-50 min-h-screen">
        ...
        <div class="max-w-7xl mx-auto px-4 py-10">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 bg-white p-6 rounded-xl shadow">
                ...
                <div class="bg-white rounded-xl flex items-center justify-center h-[420px]">
                    <img
...
<?php endif; ?><?php /**PATH C:\eyetec-new\eyetec\resources\views/products-details-page.blade.php ENDPATH**/ ?>